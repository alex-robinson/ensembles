...
program ens_grisli
    ...
    call ens_write(ens_fldr,fldrs,filename,"smb",   method="align",prec="float")
    call ens_write(ens_fldr,fldrs,filename,"Bmelt", method="align",prec="float")
    call ens_write(ens_fldr,fldrs,filename,"dTshlf",method="align",prec="float")
    call ens_write(ens_fldr,fldrs,filename,"kappa", method="align",prec="float")
    call ens_write(ens_fldr,fldrs,filename,"Tjja",  method="align",prec="float")
    call ens_write(ens_fldr,fldrs,filename,"Tb0",   method="align",prec="float")
    call ens_write(ens_fldr,fldrs,filename,"Hwat",  method="align",prec="float")
    call ens_write(ens_fldr,fldrs,filename,"U",     method="align",prec="float")
    call ens_write(ens_fldr,fldrs,filename,"Ub",    method="align",prec="float")
