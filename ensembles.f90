...
contains 
    ...
    subroutine ens_write(ens_fldr,fldrs,filename,name,tname,prec,units,method)
    ...
    subroutine ens_init(ens_fldr,fldrs,filename,names,t,tname,tunits)
        ...
        do q = 1, ndim
            ...
            write(*,"(i2,a,1x,a,1x,a)") q, trim(xname),trim(xname),trim(xunits)  
    ...
    subroutine ens_init0(ens_fldr,filename,nsim,x,xname,xunits, &
